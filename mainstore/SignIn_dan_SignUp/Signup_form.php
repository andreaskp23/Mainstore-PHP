    ...
    exit(); 
    // untuk memastikan tidak ada kode tambahan yang dijalankan setelah header redirect
    ...
    <body>
        ...
        <h2 class="txt" id="text">Sign Up</h2>
            ...
            <form action="" method="post">
                ...
                <button class="button" type="submit" id="signIn">
